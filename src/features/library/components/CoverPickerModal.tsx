        ...
        <>
            ...
            >
                    ...
                    <div className="border-b border-slate-100 px-6 py-4 dark:border-slate-800">
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <span className={cx('inline-flex', (!imageSearchQuery || isSearchingImages) && 'cursor-not-allowed')} title={!imageSearchQuery ? 'Select at least one search field' : isSearchingImages ? 'Searching...' : undefined}>
                                    <button
                                        type="button"
                    ...
                    <div className="border-b border-slate-100 px-6 py-3 dark:border-slate-800">
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                autoFocus
                            />
                            <span className={cx('inline-flex', (!customUrl.trim() || isCheckingCustomUrl) && 'cursor-not-allowed')} title={!customUrl.trim() ? 'Enter a valid image URL' : isCheckingCustomUrl ? 'Checking image link...' : undefined}>
                                <button
                ...
                <div className="flex items-center justify-end gap-3 border-t border-slate-100 px-6 py-4 dark:border-slate-800">
                    ...
                    <span className={cx('inline-flex', (selectedUrl === currentCoverUrl) && 'cursor-not-allowed')} title={selectedUrl === currentCoverUrl ? 'Select a different cover to apply' : undefined}>
                        <button
                            onClick={handleApply}
