            ...
            >
                ...
                <div className="flex items-start justify-between gap-4 border-b border-slate-100 px-6 py-4 dark:border-slate-800">
                    <div className="min-w-0">
                        <h2 id={titleId} className="text-lg font-semibold text-slate-900 dark:text-white">Choose Cover Image</h2>
                        <p className="mt-1 truncate text-sm text-slate-600 dark:text-slate-300" title={bookTitle || 'Untitled'}>{bookTitle || 'Untitled'}</p>
                        <p className="truncate text-xs text-slate-500 dark:text-slate-400" title={bookAuthors || 'Unknown Author'}>{bookAuthors || 'Unknown Author'}</p>
                    </div>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <span
                                    ...
                                    title={!imageSearchQuery ? 'Select at least one search field' : isSearchingImages ? 'Searching...' : undefined}
                                >
                                    <button
                                        type="button"
                ...
                <div className="flex items-center justify-end gap-3 border-t border-slate-100 px-6 py-4 dark:border-slate-800">
                    ...
                    <span
                        ...
                        title={selectedUrl === currentCoverUrl ? 'Select a different cover to apply' : undefined}
                    >
                        <button
                            type="button"
                            onClick={handleApply}
