...
export const LibraryBookCard = memo(function LibraryBookCard({
  ...
  if (viewMode === 'list') {
    return (
      <button
        onClick={() => onClick(id)}
        className="group flex w-full items-center gap-4 rounded-xl border border-slate-200 bg-white p-3 text-left transition hover:border-accent-400/40 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2 dark:border-slate-700/60 dark:bg-slate-800 dark:focus-visible:ring-offset-slate-900"
      >
        <input
          type="checkbox"
          checked={selected}
  ...
  return (
    <button onClick={() => onClick(id)} className="group flex cursor-pointer flex-col gap-1.5 text-left rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-900">
