            ...
            <div className="space-y-6 p-6">
                ...
                <div className="border-t border-slate-100 pt-6 dark:border-slate-700/60">
                    ...
                    <div className="relative inline-block">
                        ...
                        {isAccentOpen ? (
                            <div role="listbox" aria-label="Accent colors" className="absolute left-0 top-full z-30 mt-2 grid w-64 grid-cols-5 gap-2 rounded-xl border border-slate-200 bg-white p-3 shadow-xl dark:border-slate-700 dark:bg-slate-800">
