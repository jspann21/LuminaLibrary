            ...
            <div className="space-y-4 p-6">
                <div className="grid gap-2 md:grid-cols-[1fr_auto_auto]">
                    ...
                    <DisabledTooltip className="grid" reason={addFolderDisabledReason}>
                        <button className="rounded-lg bg-accent-600 px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-accent-700 disabled:cursor-not-allowed disabled:opacity-50" disabled={!folderPath.trim() || isAddingFolder} onClick={onAddFolder}>Add Folder</button>
                    </DisabledTooltip>
                </div>
