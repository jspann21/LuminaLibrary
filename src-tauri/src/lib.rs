...
use library::{
  commands::{
    ...
    search_brave_cover_images, search_cover_candidates, set_brave_search_api_key, set_google_books_api_key, set_library_thing_catalog_label, set_library_thing_enabled, set_scan_on_startup, start_scan,
