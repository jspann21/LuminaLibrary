...
use library::{
  commands::{
    ...
    preview_match, preview_rescan_metadata, refresh_missing_covers, remove_library_folder, rescan_file, rescan_missing_metadata, restore_all_hidden_books, restore_books,
    search_brave_cover_images, search_cover_candidates, set_book_tags, set_brave_search_api_key, set_google_books_api_key, set_library_thing_catalog_label, set_library_thing_enabled, set_scan_on_startup, start_scan,
    test_brave_search_api_key, test_google_books_api_key,
  },
